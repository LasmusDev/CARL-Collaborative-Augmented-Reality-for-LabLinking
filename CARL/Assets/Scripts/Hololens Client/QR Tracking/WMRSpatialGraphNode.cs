    ...
    internal class SpatialGraphNode
    {
        ...
        public bool TryLocate(FrameTime frameTime, out Pose pose)
        {
            pose = Pose.identity;
                ...
                Windows.Perception.Spatial.SpatialCoordinateSystem rootSpatialCoordinateSystem = PerceptionInterop.GetSceneCoordinateSystem(UnityEngine.Pose.identity) as Windows.Perception.Spatial.SpatialCoordinateSystem;
