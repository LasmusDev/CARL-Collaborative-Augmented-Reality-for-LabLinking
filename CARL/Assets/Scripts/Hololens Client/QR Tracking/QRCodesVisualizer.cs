...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
        ...
        public Action<Transform, QRCode> OnQRCodeObjectCreated;
            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        qrCodeObject.GetComponent<VisualQRCode>().qrCode = action.qrCode;
                        qrCodesObjectsList.Add(action.qrCode.Id, qrCodeObject);
                        OnQRCodeObjectCreated.Invoke(qrCodeObject.transform, action.qrCode);
                    }
